...
----------------------------------------------------------------------*/
export default function SVG_BRAND_LOGO___COMPONENT({ background_is_always_dark, background_is_always_light, background_has_opposite_theme_color }) {
...
/*-------------------------------------------------------------------
✅ Styled Components for <SVG_BRAND_LOGO___COMPONENT/>
----------------------------------------------------------------------*/

const SVG_STYLED = styled(SvgIcon)
    (({ theme }) => `
          
    ${media_queries.name_xs_sm_md_lg_xl('height', '1.8rem', '1.8rem', '1.8rem', '1.8rem', '1.8rem')}

    ${media_queries.name_xs_sm_md_lg_xl('width', '1.8rem', '1.8rem', '1.8rem', '1.8rem', '1.8rem')}
`)



/*-------------------------------------------------------------------
 ✅ propTypes of <SVG_BRAND_LOGO___COMPONENT/>
----------------------------------------------------------------------*/

SVG_BRAND_LOGO___COMPONENT.propTypes = {

    background_has_opposite_theme_color: PropTypes.bool.isRequired,
    background_is_always_dark: PropTypes.bool.isRequired,
    background_is_always_light: PropTypes.bool.isRequired
}
