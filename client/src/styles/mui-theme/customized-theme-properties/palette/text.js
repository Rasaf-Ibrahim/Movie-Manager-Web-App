    ...
    return {
        ...
        text: {
            ...
            opposite_theme: {
                ...
                icon: darkModeVariable ?  dark_secondary : light_secondary,
                primaryChannel: darkModeVariable ? "0 0 0" : "255 255 255",
                secondaryChannel: darkModeVariable ? "0 0 0" : "255 255 255",
            },
