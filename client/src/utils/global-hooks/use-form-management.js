...
import { form_empty_field_func } from "../form/form-empty-field-func";


export default function useFormManagement(form_configuration) {
...
// 🍪 generate_initial_state_and_validation_info 🍪
function generate_initial_state_and_validation_info(form_configuration) {
