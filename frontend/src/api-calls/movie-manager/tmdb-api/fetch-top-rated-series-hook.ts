...
/*__________________________________________
 ...
 ✅ hook 
____________________________________________*/
export function useFetchTopRatedSeries(page) {

    return useQuery({

        queryKey: ["fetch_top_rated_series"],

        queryFn: async () => {

            try {
                const response = await axios_movie_manager_instance.get(`/tmdb/top-rated-series?page=${page}`)
