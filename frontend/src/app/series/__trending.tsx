...
import { useFetchTrendingSeries } from "@/api-calls/movie-manager/tmdb-api/fetch-trending-series-hook"
...
export default function TRENDING___COMPONENT() {
    ...
    //  useFetchNote hook
    const { data, refetch, isFetching, isSuccess, isError, error } = useFetchTrendingSeries(page_state)
                        ...
                        return (
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem' }}>
                                ...
                                <MOVIE_CARD___REUSABLE
                                    data={data.info.trending_series}
                                    content_type='series'
                                />
