...
import { useFetchTopRatedMovies } from "@/api-calls/movie-manager/tmdb-api/fetch-top-rated-movies-hook"
...
export default function TOP_RATED___COMPONENT() {
    ...
    //  useFetchNote hook
    const { data, refetch, isFetching, isSuccess, isError, error } = useFetchTopRatedMovies(page_state)
                        ...
                        return (
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem' }}>
                                ...
                                <MOVIE_CARD___REUSABLE
                                    data={data.info.top_rated_movies}
                                    content_type='movie'
                                />
