...
import { useSearchMovie } from '@/api-calls/movie-manager/tmdb-api/search-movie-hook'
...
function MOVIE_SEARCH_RESULT___CHILD({ searchedKeyword, random_placeholder_movie }) {
    ...
    // 🍪  useSearchMovie hook
    const { isFetching, isSuccess, isError, data, error, refetch } = useSearchMovie(searchedKeyword || random_placeholder_movie)
