...
export default function html_template_for_confirm_email(otp: number): string {
    ...
    return (
        ...
        `<div style="background-color: #f5f5f5; padding: 20px;">
            ...
            <div style="background-color: #fff; color: #121212; border-radius: 10px; padding: 20px;">
                ...
                <h2 style="text-align: center;">Email Verification OTP</h2>
                
                <p style="text-align: center; font-size: 16px;">Your request to verify your email was submitted. If you did not make this request, simply ignore this email. If you did make this request, use the OTP provided below.</p>
